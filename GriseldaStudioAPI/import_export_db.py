...
def exportar_datos(ruta_carpeta:str, nombre_app:str, nombre_base_datos:str='production'):
    """
...
# json_user=exportar_datos('export', 'core_user', 'default')
# json_categoria=exportar_datos('export', 'core_categoria', 'default')
# json_producto=exportar_datos('export', 'core_producto', 'default')
# 
convertir_a_utf8("export/core_user.json")
convertir_a_utf8("export/core_categoria.json")
convertir_a_utf8("export/core_producto.json")

cargar_datos_json("export/core_user.json", 'default')
cargar_datos_json("export/core_categoria.json", 'default')
cargar_datos_json("export/core_producto.json", 'default')
